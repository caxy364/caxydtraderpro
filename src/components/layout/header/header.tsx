            ...
            <Wrapper variant='left'>
                ...
                {isDesktop && (
                    <div className="brand-text">
                        <span className="brand-text__name">Caxy Nexus AI</span>
